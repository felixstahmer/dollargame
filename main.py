...
# find circles and lines/connections between the circles
circles = circle_detection(orig_url)
lines = line_detection(orig_url, circles)
...
for circle_list in circles:
    for index, circle in enumerate(circle_list):
        ...
        dst_url = "img/circles/{}.png".format(index)
...
draw_result(connections, lines, orig_url)
